    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup data_enter">
                ...
                <form action="data/add_partnership_data.php" method="post" class="sign-in-form" style="margin-top:120px">
                    
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" name="Partnership_name" placeholder="Partnership name *" required autocomplete="off" />
                    </div>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                    ...
                    <div class="input-field">
                        ...
                        <input type="number" name="Partnership_tin" placeholder="Partnership Tin number" autocomplete="off" />
                    </div>

                    <div class="">
                        <button type="submit" name="user_type" value="2" class="btn  w-100"style="margin-bottom:100px ">Calculate Your patner Tax</button>
                    </div>
                    </br>
