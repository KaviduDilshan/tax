...
<body>
    ...
    <div class="containe">
        ...
        <form action="data/add_person_tax.php" method="post" class="mb-3">
            <input type="text" name="c_id" class="pt-2 pb-2" value="<?= $c_id; ?>" hidden />
            ...
            <div class="row  mt-3">
                ...
                <div class="col-lg-12 col-md-12">
                    <input type="text" class="pt-2 pb-2 tot_er" name="past_in2" id="past_in2" placeholder="2025/2026" />
                </div>
            </div>
            ...
            <div class="row  mt-3">
                ...
                <div class="col-12">
                    <select class="pt-2 pb-2 " name="sector" id="sector" style="width:100%;" >
            ...
            <div class="row  mt-3">
                ...
                <div class="col-lg-12 col-md-12">
                    <input type="number" class="pt-2 pb-2 tot_er" name="past_in2" id="past_in2" placeholder="0.0%" />
                </div>
            </div>
            ...
            <div class="row  mt-3">
                ...
                <div class="col-lg-12 col-md-12">
                    <input type="number" class="pt-2 pb-2 tot_er" name="past_in2" id="past_in2" placeholder="2025/2026"
                        readonly />
                </div>
            </div>
