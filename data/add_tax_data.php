...
$sql = "INSERT INTO tax (
    p_emp_slary, p_bis_net, p_inter_ern, p_rent_recived, p_any_other, p_total_ern, p_apit_paye, p_wht, p_income_tax, p_rates_paid, p_tax_pay, p_tax_sav,
    ...
    ceb, ceb_new)"
    . "VALUES(\"$p_emp_slary\",\"$p_bis_net\",\"$p_inter_ern\",\"$p_rent_recived\",\"$p_any_other\",\"$p_total_ern\",\"$p_apit_paye\",\"$p_wht\",\"$p_income_tax\",\"$p_rates_paid\",\"$p_tax_pay\",\"$p_tax_sav\",
                \"$n_emp_slary\",\"$n_bis_net\",\"$n_inter_ern\",\"$n_rent_recived\",\"$n_any_other\",\"$n_total_ern\",\"$n_apit_paye\",\"$n_wht\",\"$n_income_tax\",\"$n_rates_paid\",\"$n_tax_pay\",\"$n_tax_sav\",
                \"$ceb\",\"$ceb_new\")";
